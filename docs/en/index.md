...
hero:
  ...
  tagline: "Bilingual guides for using the zot skill to query, read, organize, and safely update Zotero content"
  image:
...
1. How agents use the `zot` skill to work with Zotero metadata, notes, PDFs, annotations, collections, feeds, and workspaces
