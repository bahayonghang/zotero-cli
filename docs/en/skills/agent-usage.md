...
phrasing. Project rules live in repo-root `AGENTS.md`. Claude Code also reads
repo-root `CLAUDE.md`. Tool loading, permissions, and evidence levels are in
[Agent harnesses](../../agents/harnesses.md).
