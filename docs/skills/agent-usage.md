...
Claude Code、Codex、Grok Build、Kimi Code、Oh My Pi（OMP）共用这套开口方式。仓库规则见根目录 `AGENTS.md`。Claude Code 另读根目录 `CLAUDE.md`。工具加载、权限与证据等级见 [Agent 工具矩阵](../agents/harnesses.md)。
